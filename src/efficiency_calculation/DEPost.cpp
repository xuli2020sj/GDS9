...
if(key==0)
{
	...
	_WD1.Cylinder(_PWaste,'z',28,2000);//�ھ�
	_WD2.Cylinder(_PWaste,'z',28.15,2000);//�ھ�

}
else
{
	_PWaste.SetPoint(0,0,0);
	_WD1.Cylinder(_PWaste,'z',35,2000);//�ھ�
	_WD2.Cylinder(_PWaste,'z',35.2,2000);//�ھ�
}
EProcess2(key);
*/
    return true;
...
//	if(!EHead)
//	{
//		AfxMessageBox(_T("δ�ܶ�ȡE_Points����"));
//		return;
//	}
//	///////////////����
...
//		{//j
//			node23=node22;
//			for(nd=0;nd<NuDensity;nd++)//��ͬ�ܶ�
//			{//nd
//				node13=node12;
//				sumangle=0;
//				for(k=0;k<EHead->NuNodesInX-1;k++)//Բ�ܷ���
//				{//k
...
//					{//e
//						//1 ��� 2water 3Polyethylene 4Concrete 5Glass 6Al 7Ge 8Fe 9Cu 10Pb ����ˮ
...
//			{
//				  TriDataB.Interpolation(node12,2,0,999,e,xdata_R,ydata_R,NR_Chazhi+1);//��ֵ
//				  node23=node22;
...
//			{
//				  TriDataB.Interpolation(node12,3,0,999,e,xdata_H,ydata_H,NH_Chazhi+1);//��ֵ
//				  node23=node22;
...
//				//AfxMessageBox(CTemp);
//				if(y_middle<R_Y[j+1]&&y_middle>=R_Y[j])//�����Բ����Χ��
//				{
//					sumR+=y_middle;//Ȩ�����
//					for(e=0;e<EHead2->NuDataUsed;e++)
//					{
//						E_middle=(node13->data[e]+node13->NextY->data[e])/2;
//						sum_E_R[e]+=E_middle*y_middle;//Ч�ʶ԰뾶��Ȩ���
//					}
//				}
...
//	node11=EHead4->FirstNode;//ע����EHead2
...
//		{
//			node13=node12;
//			for(e=0;e<EHead4->NuDataUsed;e++)//��ֵ
//				Sum[e]=0;
//			for(k=0;k<EHead4->NuNodesInY;k++)//�뾶����
//			{
...
//		node12=node11;
//		node22=node21;
//		for(k=0;k<EHead6->NuNodesInY;k++)//�뾶����
//		{
//			for(e=0;e<EHead6->NuDataUsed;e++)
//			{//e
//				node13=node12;
//				//���ղ�ֵ��λ������Ч�ʿ�����������
//				//�ٶ���ÿ����ֵ�߶���һ����������Ч�������Ч����ͳ����ܹ�����������0��H�߶ȣ�
//				//����ɨ������Щ��ֵ�߶ȵ�Ч����ƽ��ֵ
//				for(j=0;j<EHead_CZ2->NuNodesInZ;j++,node13=node13->NextZ)//�߶ȷ���
//					E_h[j]=node13->data[e];
...
//	if(key200_400==0)  Title.Format("�̶Ƚ�����Waste Drum 200_%d",NoY);
//	else Title.Format("�̶Ƚ�����Waste Drum 400_%d",NoY);
//	AfxMessageBox(Title);
//}
